...
export function CardHorizontalFood({ food }: {food: FoodProps }) {
  return (
    <Pressable className="flex flex-col rounded-xl relative">
        ...
        />
        <View className="flex flex-row bg-neutral-900/90 w-fit gap-1 rounded-se-xl rounded-es-xl rounded-s-md rounded-e-md absolute top-2 right-3 px-2 py-1 items-center justify-center">
